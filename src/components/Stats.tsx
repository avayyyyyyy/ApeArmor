...
const Stats = () => {
  return (
    <div className="lg:bg-foreground/5 overflow-hidden  h-fit lg:py-20 lg:my-20 mx-auto  lg:rounded-lg lg:shadow-2xl lg:mt-14 max-w-[80vw] lg:border border-primary">
      <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
        ...
        <div className="mt-8 animate-marquee sm:mt-12">
